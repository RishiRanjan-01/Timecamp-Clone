...
import { Center, Image, Spinner, useToast } from '@chakra-ui/react';
...
//   }
  ...
  const handlePayment=(e)=>{
    e.preventDefault()
      ...
      if( expireYear==='YYYY' || cardHolder===''){
        toast({
            
            position: 'top',
            title: "can't left empty feilds",
      ...
      setTimeout(function(){
        ...
        toast({
            ...
            description: "directing to invoice page",
            status: 'success',
            duration: 9000,
            isClosable: true,
          })
       ...
       <div className="container">
        ...
        <form id="form">
            ...
            <div className="input-container">
                <h4>Card Holder</h4>
                <input onChange={handleCardHolder} value={cardHolder} type="text" placeholder="Please enter your full name" required/>
            </div>
            ...
            {toggle===false?<button onClick={handlePayment}> {`Submit ${cardType} payment`}</button>:''}
            {toggle===true?  <button onClick={handlePayment}> <Spinner size={'lg'}/></button>:''}
        </form>
