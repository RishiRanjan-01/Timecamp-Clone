...
const InvoiceInformation = () => {
 ...
 const toast=useToast()
  ...
  return (
    ...
    { pay===true?<Box height={"76vh"}  overflowY="scroll" margin='auto' textAlign='center' width='50%'><Image textAlign={'center'} src='https://i.pinimg.com/originals/f8/c4/22/f8c422a0a0e6793b3f9113d419c5143a.gif'/></Box>:null}
