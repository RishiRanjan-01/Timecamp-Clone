...
const Tabb = () => {
  return (
    <Box>
        <Text mt='20' color='green' textAlign='center' fontWeight='600'>PRICING</Text>
    ...
    <TabPanel mt='10'>
     <Flex gap='5' justifyContent='center' direction={{base:'column',sm:'column',md:'column',lg:'row'}}>
        ...
        <Box boxShadow='md' rounded='xxl' bg='white' borderRadius='15px' p='5' w={{base:'100%',sm:'100%',md:'100%',lg:'25%'}}>
            ...
            <Box borderBottom='2px solid green' pb='3'>
                <Heading textAlign='center' color='green'>Free</Heading>
            <Text textAlign='center'>Free forever plan</Text>
            </Box>
            
            <Text my='5'>Measure on which activities you spend time while working</Text>

            <Text textAlign='center' py='3' backgroundColor='green' color='white' borderRadius='25px' >Join for free</Text>
        ...
        <Box boxShadow='md' rounded='xxl' bg='white' borderRadius='15px' p='5' w={{base:'100%',sm:'100%',md:'100%',lg:'25%'}}>
            <Text textAlign='center' color='green' fontSize='8px' fontWeight='bold'>BASIC</Text>

            <Box borderBottom='2px solid green' py='3'>
            ...
            <Text textAlign='center' py='3' backgroundColor='green' color='white' borderRadius='25px' >Start your free trial</Text>
        ...
        <Box bgColor='green' w={{base:'100%',sm:'100%',md:'100%',lg:'25%'}} borderRadius='15px'>
            <Flex justifyContent='flex-end' fontSize='8px' fontWeight='bold'>
                 <Text py='1' px='2' color='white'>PRO</Text>
            <Text  py='1' px='2' borderRadius='20px' bgColor='white' color='green'>POPULAR</Text>
            </Flex>
            <Box py='3' px='4'>
           ...
           <Box borderBottom='2px solid white' pb='3' >
            ...
            <Text my='5' color='white'>Get full control over your business</Text>
             ...
             <Text textAlign='center' py='3' backgroundColor='white' color='green' borderRadius='25px' >Start your free trial</Text>
        ...
        <Box boxShadow='md' rounded='xxl' bg='white' borderRadius='15px' p='5' w={{base:'100%',sm:'100%',md:'100%',lg:'25%'}} >
            <Text textAlign='center' color='green' fontSize='8px' fontWeight='bold'>ENTERPRISE</Text>

            <Box  borderBottom='2px solid green' pt='3' pb='8'>
            ...
            <Text my='5'>Customize TimeCamp to your custom needs</Text>
             ...
             <Text textAlign='center' py='3' backgroundColor='green' color='white' borderRadius='25px' >Contact us</Text>
...
<Flex gap='3' alignItems='center'><BiLock/>SSL Secure Payment</Flex>
</Box>
  )
}
